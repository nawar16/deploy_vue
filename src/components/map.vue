...
export default {
  ...
  data () {
    return {
      ...
      minzoom:13, //1 or 13
      maxzoom:18, //18
      center: L.latLng(34.7324, 36.7137),
      url:'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
      attribution:'&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
      marker: L.latLng(34.7324, 36.7137),
      icon: L.icon({
      ...
      menuCoor: L.latLng(34.7324, 36.7137),
      summary: [0, 0],
      summary_bool: false,
      myMarkers: [],
      myData: [],
  ...
  created(){
    if (this.youllbeawoman) {
      //put it false so that no queries are made every time the page is visited
  ...
  updated(){
      ...
      console.log(this.machineControl._routes[0].summary.totalDistance);
  }
}
</script>
