              ...
              <b-modal id="traveling" title="Travel" @ok="startingTravel">
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      <td>Driver Name: </td>
                      <td class="tdstyle"><b>{{driverData.fname}} {{driverData.lname}}</b></td>
                    </tr>
                    <tr>
                      <td>Driver Phone:</td>
                    ...
                    <tr>
                      <td>Vehicle Brand:</td>
                      <td class="tdstyle"><b>{{driverData.mark}}</b></td>
                    </tr>
                    <tr>
                      <td>Vehicle Model:</td>
                      <td class="tdstyle"><b>{{driverData.model}}</b></td>
                    </tr>
                    <tr>
                      <td>Vehicle Plate:</td>
                      <td class="tdstyle"><b>{{driverData.license_plate}}</b></td>
                    </tr>
                    <tr>
                      <td>Driver Qualification:</td>
                      <td class="tdstyle"><b id="cal">{{driver_qualification}}</b></td>
                    </tr>
                    <tr>
                      <td>Distance:</td>
...
export default {
  computed: {
    ...
    driver_qualification(){
      return this.$store.getters.driver_qualification;
    },
    // youllbeawoman(){
